...
resource "aws_ssm_parameter" "app_alb_sg_id" {
  name  = "/${var.project_name}/${var.environment}/app_alb_sg_id" #  /expense/dev/ansible_sg_id
  type  = "String"
  value = module.app_alb_sg.id
}

resource "aws_ssm_parameter" "web_alb_sg_id" {
  name  = "/${var.project_name}/${var.environment}/web_alb_sg_id" #  /expense/dev/ansible_sg_id
  type  = "String"
  value = module.web_alb_sg.id
}

resource "aws_ssm_parameter" "vpn_sg_id" {
  name  = "/${var.project_name}/${var.environment}/vpn_sg_id" #  /expense/dev/ansible_sg_id
  type  = "String"
